...
NFT Marketplace is a decentralized shop where users can buy and sell NFTs. It contails two pages:
...
You can find the back-end [here](https://github.com/yersel500/nft-marketplace).
...
After installing dependencies with `yarn install`, start a node on it's own terminal with:
